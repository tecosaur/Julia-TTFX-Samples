...
issue_checkboxes = (;
    ...
    taskjuliaup = IssueItemState("Let JuliaUp do some pointless checks"),
...
tasktimeplaceholder = string(rand(UInt64), base=62)
...
taskhash = readchomp(`git hash-object $taskfile`)
